...
public class SosoChaGuanZhu extends Activity {
	ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.guan_zhu_sosocao_activity);
		sss = new String[] {"zhuti_icon","zhuti_title","zhuti_tu1","zhuti_tu2","zhuti_tu3"};
		in = new int[] { R.id.guan_zhu_shangbiao, R.id.guan_zhu_shanghu, R.id.guan_zhu_datu,
				R.id.guan_zhu_xiaotu1,R.id.guan_zhu_xiaotu2};
		listView = (ListView) findViewById(R.id.list_view_guan_zhu);
	...
	public void simpleAdapter(){ 
         //实例适配器  
         SimpleAdapter cha = new SimpleAdapter(this, list, R.layout.guan_zhu_list_view 
                    , sss, in  );  
